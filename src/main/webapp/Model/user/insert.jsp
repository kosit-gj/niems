...
//if(role.equals("Admin")){
  ...
  query+=" (\"user_name\",\"password\",\"prefix\",\"first_name\",\"last_name\",\"email\",\"tel\",\"province\",\"status\",\"position\",\"organization\",\"user_items\",\"role_id\",\"create_dttm\",\"updated_dttm\")";
  query+=" VALUES('"+user_name+"','"+passwordMD5+"','"+prefix+"','"+first_name+"','"+last_name+"','"+email+"','"+tel+"','"+province+"','"+status+"','"+position+"','"+organization+"','"+user_items+"','"+role_id+"',"+create_dttm+","+updated_dttm+")";
